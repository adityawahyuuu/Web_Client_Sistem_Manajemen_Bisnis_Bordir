<script>
  ...
  import { clearCompanyState } from '../stores/company.js';
  ...
  const mainMenuItems = [
    ...
    { path: '/items', label: 'Item/Produk', icon: 'M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4' },
  ...
  const settingsMenuItems = [
    { path: '/companies', label: 'Perusahaan', icon: 'M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4' },
    { path: '/template-editor', label: 'Template Dokumen', icon: 'M4 5a1 1 0 011-1h14a1 1 0 011 1v2a1 1 0 01-1 1H5a1 1 0 01-1-1V5zM4 13a1 1 0 011-1h6a1 1 0 011 1v6a1 1 0 01-1 1H5a1 1 0 01-1-1v-6zM16 13a1 1 0 011-1h2a1 1 0 011 1v6a1 1 0 01-1 1h-2a1 1 0 01-1-1v-6z' }
  ];
...
<aside class="w-64 bg-white border-r border-gray-200 min-h-screen flex flex-col">
  ...
  <div class="p-4 border-b border-gray-200">
    <div class="flex items-center gap-2 mb-3">
      ...
      <div>
        <h1 class="text-lg font-bold text-gray-900">Bordir System</h1>
